...
//
// ContentTools (@jamesjnadeau/content-tools, copied beside this file by
// .eleventy.js) edits the repository through GitHub's REST API with a bearer token. Here the
...
// (boot.js) import this. Ported from vermont-football-officials, which runs
// the same editor the same way; keep fixes to one in step with the other.
...
const REPO = 'jamesjnadeau/jamesjnadeau.com';
const BRANCH = 'master';
...
const FROM_SESSION = 'jjn:token-from-identity';
...
export class IdentityAdapter {
  gate = {
    label: 'Sign in',
    note: 'Sign in with your jamesjnadeau.com site account.',
  };
