  ...
  <div class="content">
    ...
    <div class="content d-flex flex-column">
      ...
      <div class="card card-default my-3">
        ...
        <div class="card-collapse collapse" id="more_about_me">
          <div class="card-body">
            <p>
      ...
      <div class="card card-default my-3">
        <div class="card-header">
          <h4
            class="card-title text-center m-"
            data-toggle="collapse"
            href="#more_about_this_site">
            More About This Site
          </h4>
        </div>
        <div class="card-collapse collapse" id="more_about_this_site">
          <div class="card-body">
            <p>
              This site is built using webpack along with a custom loadder I
              created called&nbsp;
